...
# file locations
static_dv_file = 'InferenceRuns/debiasB/static_datavectors_seed'+str(RANDOM_SEED)+'.json'
...
BACKEND_PATH = 'InferenceRuns/debiasB/w0wa_seed'+str(RANDOM_SEED)+'_backend.h5'
RESET_BACKEND=True
