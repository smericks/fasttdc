...
# file locations
static_dv_file = 'InferenceRuns/exp5_1/static_datavectors.json'
...
BACKEND_PATH = 'InferenceRuns/exp5_1/lcdm_backend.h5'
RESET_BACKEND=True
...
likelihood_configs = {
    ...
    '4MOST_quads':{
        'posteriors_h5_file':gold_quads_h5_file,
        'metadata_file':gold_metadata_file,
        'catalog_idxs':truth_df_catalog_idxs[fourmost_quads_idxs[:30]],
        'cosmo_model':COSMO_MODEL,
    ...
    '4MOST_dbls':{
        'posteriors_h5_file':gold_dbls_h5_file,
        'metadata_file':gold_metadata_file,
        'catalog_idxs':truth_df_catalog_idxs[fourmost_dbls_idxs[:30]],
        'cosmo_model':COSMO_MODEL,
        'td_meas_error_percent':None,
        'td_meas_error_days':2., #TODO: switch to histogram
        'kappa_ext_meas_error_value':0.05,
