...
# file locations
static_dv_file = 'InferenceRuns/exp4_3/static_datavectors_seed'+str(RANDOM_SEED)+'.json'
...
BACKEND_PATH = 'InferenceRuns/exp4_3/w0wa_seed'+str(RANDOM_SEED)+'_backend.h5'
RESET_BACKEND=True
