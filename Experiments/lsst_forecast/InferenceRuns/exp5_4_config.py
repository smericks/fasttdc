# experiment 5.4: 2-day LSST light curves...
...
# file locations
static_dv_file = 'InferenceRuns/exp5_4/static_datavectors_seed'+str(RANDOM_SEED)+'.json'
...
BACKEND_PATH = 'InferenceRuns/exp5_4/w0wa_seed'+str(RANDOM_SEED)+'_backend.h5'
RESET_BACKEND=True
