...
BACKEND_PATH = 'InferenceRuns/exp0_2/w0wa_seed'+str(RANDOM_SEED)+'_no_jackpot_backend.h5'
RESET_BACKEND=True
...
# remove the hypothesized "jackpot" lens from being available 
jackpot_lenses = [1199]
gold_df = gold_df[~gold_df['catalog_idx'].isin(jackpot_lenses)].reset_index(drop=True)
