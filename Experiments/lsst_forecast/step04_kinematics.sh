...
python3 galkin_sherlock_script.py --lens_idx=$1 --h5_posteriors_path=/scratch/users/sydney3/forecast/darkenergy-from-LAGN/Experiments/lsst_forecast/DataVectors/gold/dbl_posteriors.h5
